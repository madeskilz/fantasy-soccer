...
class GamesController extends Controller
{
    ...
    public function create()
    {
        ...
        $home_teams = \App\Team::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');
        $away_teams = \App\Team::get()->pluck('name', 'id')->prepend(trans('quickadmin.qa_please_select'), '');

        return view('admin.games.create', compact('home_teams', 'away_teams'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.games.edit', compact('game', 'home_teams', 'away_teams'));
    }
